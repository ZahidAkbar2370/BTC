...
@section('content')
 ...
 <div class="card container rounded border" style="background-color: white;margin-bottom: 20px;margin-top: 20px;">
...
<input type="hidden" name="hidden_recived_amount" value='@php
                    $bitcoin_value=CH::Get_Latest_Bitcoin_value()[0]->price;

                    $additional_value=CH::Get_Latest_Additional_price()[0]->cryptocurrency_additional_price;

                    $user_bitcoin_entered_count=$order_data['reqData']['bitcoin_entered_amount'];

                    $transaction_fee=CH::Get_Latest_Commision()[0]->transaction_fee;
                           

                    $total_value_of_bitcoin=($bitcoin_value+$additional_value)*$user_bitcoin_entered_count;

                    $commission_fee=($total_value_of_bitcoin)*($transaction_fee/100);
...
<tbody >
<tr>
<td colspan="2"><h1 style="text-align: center;font:bold;">Send Bitcoin to this</h1></td>
</tr>
<tr>
...
<tr>
<td style="font:bold;font-size:18px"><b>Amount in BTC</b></td>
...
<t><td style="font:bold;font-size:18px"><b>Waiting Your Bitcoin</b></td>
...
<td style="vertical-align: middle;"><div class="spinner-border text-warning" role="status" style="width:110px;height: 110px">
...
<tr>
<td style="font:bold;font-size:18px"><b>Transaction ID</b>
</td>

<td>
<input type="text" name="transection_url" class="form-control" id="confirm_oder_pay_id" maxlength="120" placeholder="www.blockchain.info/tx-index/cb56e59ec9aa59bfbd43db44d65c6406051739be3c4850cc5aab0c498c743dd3
">
</td>
...
<tr>
<td style="font:bold;font-size:18px"><b>1 Bitcoin = </b></td>
<td style="font:bold;font-size:18px"> &nbsp;&nbsp;&nbsp;&nbsp;<b> @php
                           echo $bitcoin_current_val=CH::Get_Latest_Bitcoin_value()[0]->price+
                            CH::Get_Latest_Additional_price()[0]->cryptocurrency_additional_price;
            echo "<input type='hidden' name='bitcoin_current_val' value='$bitcoin_current_val'>";                
@endphp $</b></td>
</tr>
...
<td style="font:bold;font-size:18px">&nbsp;&nbsp;&nbsp;&nbsp;<b>@php
                           echo ((CH::Get_Latest_Bitcoin_value()[0]->price+
                            CH::Get_Latest_Additional_price()[0]->cryptocurrency_additional_price)*$order_data['reqData']['bitcoin_entered_amount']);
@endphp $ </b></td>
</tr>
